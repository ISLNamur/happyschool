    ...
    methods: {
        ...
        pushStudentAbs: function () {
            ...
            if (!this.studentAbsenceState) {
                axios.get(`/student_absence/api/period/?start__lt=${this.absence.period.end}&end__gt=${this.absence.period.start}`)
                    .then(resp => {
                        ...
                        axios.post("/student_absence/api/student_absence/", data, token)
                            .then(() => {
                ...
                const studentAbsencePromise = this.relatedStudentAbsence.map(studAbs => {
                    ...
                    return axios.put(`/student_absence/api/student_absence/${studAbs.id}/`, data, token);
                });
        ...
        pullStudentAbs: function () {
            ...
            axios.patch(`/student_absence_teacher/api/absence/${this.absence.id}/`, data, token)
                .then(() => {
                    this.$emit("update");
                    this.updating = false;
                });
