...
<template>
    <b-container>
            ...
            <b-row>
                <b-btn class="mb-2" to="/"> Retour à la liste des passages</b-btn>
            </b-row>
            <b-row>
                <b-col sm="4">
                ...
                <b-col>
                    <b-form @submit="submit" @reset="reset">
                        ...
                        <b-form-row>
                        <b-col>
                            <b-form-group label="Motifs d'admissions :" label-for="input-admission" :state="inputStates.motifs_admission">
