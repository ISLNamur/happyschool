...
if USE_LDAP_INFO:
    ...
    AUTH_LDAP_USER_SEARCH = LDAPSearch(
        "ou=people,%s" % LDAP_DOMAIN, ldap.SCOPE_SUBTREE, "(uid=%(user)s)"
    )
    ...
    AUTH_LDAP_GROUP_SEARCH = LDAPSearch(
        "ou=groups,%s" % LDAP_DOMAIN, ldap.SCOPE_SUBTREE, "(objectClass=groupOfNames)"
    )
    ...
    SYNC_FDB_SERVER = [
        {
            ...
            "server": fdbserver.FDBServer(
                host="192.168.1.1",
                path="C:/ProEco/DataFB/",
                user="complex_login",
