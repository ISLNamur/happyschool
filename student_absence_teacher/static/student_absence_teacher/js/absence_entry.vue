...
<template>
    <div>
        <b-card no-body :class="studentAbsenceClass">
            <b-row class="m-1">
                <b-col>
                ...
                <b-col v-if="studentAbsenceComparison !== 'match'" cols="12" sm="6" lg="6" class="text-right">
