    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_week_day', models.PositiveSmallIntegerField(blank=True, choices=[(None, 'Choisir un jour de la semaine'), (1, 'Lundi'), (2, 'Mardi'), (3, 'Mercredi'), (4, 'Jeudi'), (5, 'Vendredi'), (6, 'Samedi')], null=True)),
                ('delay', models.PositiveSmallIntegerField(blank=True, default=1, help_text="Le nombre de jour avant de postposer la sanction à la semaine d'après.\n        Par exemple, pour une valeur de 1, si le retard qui déclenche la sanction a lieu\n        le même jour de la semaine que la sanction, la sanction sera mise la semaine prochaine\n        parce qu'il y a moins de 1 jour de différence. Au contraire, si le retard à lieu 1 jour\n        avant le jour de sanction, la sanction sera mise le lendemain.", null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime_creation', models.DateTimeField(auto_now_add=True, verbose_name='Date et heure de création du retard')),
                ('datetime_update', models.DateTimeField(auto_now=True, verbose_name='Date et heure de mise à jour du retard')),
                ('student', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.StudentModel')),
            ],
        ),
    ]
