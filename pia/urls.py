...
router.register(r"api/other_adjustments", views.OtherAdjustmentsViewSet)
...
router.register(r"api/activity_support", views.ActivitySupportViewSet)
router.register(r"api/course_reinforcement", views.CourseReinforcementViewSet)
...
router.register(r"api/intermediate_evaluation", views.IntermediateEvaluationViewSet)
